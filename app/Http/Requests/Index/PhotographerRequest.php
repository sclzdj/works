        ...
        switch ($this->getScene()) {
            case 'savePhotographerWorkSourceStore':
                $rules = [
                    ...
                    'sources.*.width' => 'required',
                    'sources.*.height' => 'required',
                    'sources.*.imageAve' => 'required',
//                    'sources.*.exif' => 'required',
                ];
                break;
...
//                    'tags' => 'array',
//                    'tags.*' => 'array|max:50',
//                    'photographer_gather_id' => 'array',
//                    'photographer_gather_id.*' => 'array|max:50',
                ];
                break;
            case 'savePhotographerStore':
                $rules = [
                    'name' => ['required', new ValidateWordSecurity],
//                    'name' => 'string|max:32',
