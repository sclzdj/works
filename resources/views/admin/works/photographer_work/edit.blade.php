                        ...
                        <div class="block-content">
                            <form class="form-horizontal form-builder row" id="create-form">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="col-md-6 form-option-line">
                                        <input class="form-control" name="project_amount" placeholder="请输入项目金额"
                                               value="{{$photographerWork->project_amount}}">
                                    </div>
                                    <div class="col-md-5 form-control-static form-option-line">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="col-md-11 form-option-line">
                                        <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                            <input type="radio" name="hide_project_amount" value="0"
                                                   @if($photographerWork->hide_project_amount==0) checked @endif>
                                            <span></span> 显示
                                        </label>
                                        <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                            <input type="radio" name="hide_project_amount" value="1"
                                                   @if($photographerWork->hide_project_amount==1) checked @endif>
                                            <span></span> 隐藏
                                        </label>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="col-md-6 form-option-line">
                                        <input class="form-control" name="sheets_number" placeholder="请输入成片张数"
                                               value="{{$photographerWork->sheets_number}}">
                                    </div>
                                    <div class="col-md-5 form-control-static form-option-line">
                                        <div class="help-block help-block-line">只能是数字</div>
                                    </div>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="col-md-11 form-option-line">
                                        <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                            <input type="radio" name="hide_sheets_number" value="0" @if($photographerWork->hide_sheets_number==0) checked @endif>
                                            <span></span> 显示
                                        </label>
                                        <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                            <input type="radio" name="hide_sheets_number" value="1" @if($photographerWork->hide_sheets_number==1) checked @endif>
                                            <span></span> 隐藏
                                        </label>
                                        <span class="form-control-static form-option-line help-line">隐藏后前台将不再展示</span>
                                    </div>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="col-md-6 form-option-line">
                                        <input class="form-control" name="shooting_duration" placeholder="请输入拍摄时长"
                                               value="{{$photographerWork->shooting_duration}}">
                                    </div>
                                    <div class="col-md-5 form-control-static form-option-line">
                                        <div class="help-block help-block-line">只能是数字</div>
                                    </div>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                    ...
                                    <div class="col-md-11 form-option-line">
                                        <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                            <input type="radio" name="hide_shooting_duration" value="0" @if($photographerWork->hide_shooting_duration==0) checked @endif>
                                            <span></span> 显示
                                        </label>
                                        <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                            <input type="radio" name="hide_shooting_duration" value="1" @if($photographerWork->hide_shooting_duration==1) checked @endif>
                                            <span></span> 隐藏
                                        </label>
                                        <span class="form-control-static form-option-line help-line">隐藏后前台将不再展示</span>
                                    </div>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="create-sources">
                                    ...
                                    <div class="col-md-6 form-option-line">
                                        <textarea class="form-control" rows="18" name="sources"
                                                  placeholder="请输入资源前，认真阅读输入资源的规则">{{$photographerWorkSources}}</textarea>
                                    </div>
                                    <div class="col-md-5 form-control-static form-option-line">
                                        ...
                                        <div class="help-block help-block-line">资源key最好为<span style="color: #f00000">28个大小写随机字母、数字</span>构成，前面再加上“<span
                                                style="color: #f00000">SD_</span>”标识，不带后缀名
                                        </div>
    ...
    <script>
        $(function () {
            $(document).on('click', '#create-submit', function () {
                ...
                $.ajax({
                    type: 'PUT',
                    url: '{{action('Admin\Works\PhotographerWorkController@update',['id'=>$photographerWork->id])}}',
                    dataType: 'JSON',
                    data: data,
            ...
            function photographerWorkCustomerIndustryInit() {
                ...
                var photographer_work_customer_industry_id = {!! $photographerWork->photographer_work_customer_industry_id !!};
                ...
                $(photographerWorkCustomerIndustries).each(function (k, v) {
                    ...
                    $(v.children).each(function (_k, _v) {
                        ...
                        if (_v.id == photographer_work_customer_industry_id) {
                            ...
                            html2_select_index = v.id;
                            $('.photographer-work-customer-industry-box-1.hidden-value').val(photographer_work_customer_industry_id);
                        }
            ...
            function photographerWorkCategoryInit() {
                ...
                var photographer_work_category_id = {!! $photographerWork->photographer_work_category_id !!};
                var html1 = '<option value="">请选择</option>';
                var html2 = [];
                var html2_0 = '<option value="">请选择</option>';
                var html2_init = html2_0;
                ...
                $(photographerWorkCategories).each(function (k, v) {
                    ...
                    $(v.children).each(function (_k, _v) {
                        ...
                        if (_v.id == photographer_work_category_id) {
                            ...
                            selected_html2 = 'selected';
                            html2_select_index = v.id;
                            $('.photographer-work-category-box-1.hidden-value').val(photographer_work_category_id);
                        }
                        html2[v.id] += '<option value="' + _v.id + '" ' + selected_html2 + '>' + _v.name + '</option>';
                    });
                    html1 += '<option value="' + v.id + '" ' + selected_html1 + '>' + v.name + '</option>';
