...
class CreatePhotographerWorkCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('photographer_work_categories', function (Blueprint $table) {
            $table->engine = 'innodb';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('photographer_work_categories');
    }
}
