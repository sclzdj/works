...
class CreateTemplatesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('templates', function (Blueprint $table) {
            ...
            $table->string("text2", 255)->default("")->nullable()->comment("文案2");
            $table->string("text3", 255)->default("")->nullable()->comment("文案3");
            $table->string("text4", 255)->default("")->nullable()->comment("文案4");
